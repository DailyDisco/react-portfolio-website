...
// this shows the logo behind the body text
const Logo = () => {
    ...
    useEffect(() => {
        ...
        // gsap is the library of choice of animations
        gsap.registerPlugin(DrawSVGPlugin)


        // .timeline calls the animations in a sequence. 
        // .to function represents the end state of an animation. The first argument is the element we want to animate. The second arguments set the properties in the object. */}
        // .from function is similar to the .to function. Same arguments. 
        gsap 
          .timeline()
          .to(bgRef.current, {
            duration: 1,
        ...
        // .fromTo function fades in the solid logo when the animation is done.
        gsap.fromTo(
      ...
      // we use an empty array here to make sure that the function only executes once.
    ...
    return (
        <div className='logo-container' ref={bgRef}> 
            ...
            {/* What is svg for and where do I access it? */}
            <svg
                width="559pt"
                height="897pt"
                version="1.0"
